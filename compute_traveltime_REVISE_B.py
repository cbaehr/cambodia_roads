...
for i in [2010, 2015, 2020]:
	...
	for j in range(0, chunks):
		...
		to_pts=out
		out_tt = os.path.join(base, "market_access/market_access_{}_REVISE_B.geojson".format(i))
		...
		###
		inp=out_tt
		out_path=os.path.join(base, "market_access/market_access_{}_trimmed_{}_REVISE_B.geojson".format(i, j))
