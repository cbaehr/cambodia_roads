...
empty_grid_out = os.path.join(base_path, "empty_grid_trimmed_REVISE_variedbuffers.geojson")
...
csv_out=os.path.join(base_path, "cambodia_roads_grid_REVISE_variedbuffers.csv")
grid.drop(["geometry"],axis=1).to_csv(csv_out, index=False)


geo_out=os.path.join(base_path, "cambodia_roads_grid_REVISE_variedbuffers.geojson")
